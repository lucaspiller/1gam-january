...
DomRenderComponent = (function(_super) {
  var createElementForBall, formatScore, formatTime, getTimestamp, lengthToPx;
...
Game = (function() {
  ...
  Game.prototype.gameLoop = function() {
    ...
    this.options.renderComponent.updateTimer((getTimestamp() - this.startTime) / 1000, this.options.totalTime);
