...
var $, Ball, Character, DomRenderComponent, Game, KeyboardInputComponent, LevelSelect, NullInputComponent, NullRenderComponent,
...
LevelSelect = (function() {
  ...
  LevelSelect.prototype.start = function() {
    var _this = this;
    return $(this.domElement).on('click', '[data-level]', function(e) {
      var level;
  ...
  LevelSelect.prototype.playLevel = function(level) {
    ...
    this.hide();
    $('#sausis button.play-again').click(function() {
      return game.start();
    });
    return game.start();
  };
...
DomRenderComponent = (function(_super) {
  ...
  DomRenderComponent.prototype.showGameOverScreen = function(finalScore, finalDistance) {
    var gameover;
...
Game = (function() {
  ...
  Game.prototype.triggerGameOver = function() {
    ...
    return this.options.renderComponent.showGameOverScreen(this.score, this.distance);
  };
