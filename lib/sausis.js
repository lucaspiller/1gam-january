...
initGame = function() {
  var COLOURS, INITIAL_CHARACTER_COLUMN, INITIAL_COLUMNS, INITIAL_ROWS, MAX_ROWS, NEW_ROW_INTERVAL, addRow, addRowOrRestartGame, alive, balls, board, characterBalls, characterColumn, column, columnIndex, columns, countRows, findAndDestroyBalls, gameLoop, handleKeyboardInput, keys, moveCharacterToColumn, pullBall, pushBall, rowIndex, rows, tupleExists, _i, _j, _ref, _ref1;
  $('#sausis .board').remove();
  board = $('<div/>');
