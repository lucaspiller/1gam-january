...
LevelSelect = (function() {
  ...
  LEVEL_TEMPLATE = "    <div class='level' data-level='<%= index %>'>      <h2><%= config.name %></h2>      <span class='score'><%= highscore.score %></span>      <span class='distance'><%= highscore.distance %></span>    </div>  ";
  ...
  LevelSelect.prototype.buildLevels = function() {
    var config, highscore, level, levelIndex, _i, _len, _results;
