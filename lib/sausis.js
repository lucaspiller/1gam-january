...
initGame = function() {
  var COLOURS, INITIAL_CHARACTER_COLUMN, INITIAL_COLUMNS, INITIAL_ROWS, MAX_ROWS, NEW_ROW_INTERVAL, addRow, alive, balls, board, characterBalls, characterColumn, column, columnIndex, columns, countRows, findAndDestroyBalls, gameLoop, handleKeyboardInput, handleTimers, keys, moveCharacterToColumn, nextRowAt, pullBall, pushBall, rowIndex, rows, tupleExists, _i, _j, _ref, _ref1;
  $('#sausis .board').remove();
  board = $('<div/>');
  ...
  nextRowAt = 0;
  addRow = function() {
    var ball, colour, rowIndex, _j, _ref1;
    rowIndex = rows++;
    ...
    return nextRowAt = new Date().getTime() + NEW_ROW_INTERVAL;
  };
  ...
  findAndDestroyBalls = function(pushedColumnIndex) {
    var columnBalls, deleteToIndex, pushedColour, searched, toDelete, toSearch, x, y, _k, _l, _len, _m, _ref2, _ref3, _ref4, _ref5;
    ...
    if ((columnBalls.length - 1) - rowIndex >= 3) {
      ...
      while (toSearch.length > 0) {
        _ref4 = toSearch.shift(), x = _ref4[0], y = _ref4[1];
      ...
      for (_m = 0, _len = toDelete.length; _m < _len; _m++) {
        _ref5 = toDelete[_m], x = _ref5[0], y = _ref5[1];
        balls[x][y].addClass('remove');
        balls[x].splice(y, 1);
      }
      return setTimeout(function() {
        return $('.ball.remove').remove();
      }, 300);
    }
  };
  tupleExists = function(tuple, array) {
    var ax, ay, i, x, y, _k, _len, _ref2;
    x = tuple[0], y = tuple[1];
