...
DomRenderComponent = (function(_super) {
  ...
  DomRenderComponent.prototype.buildGameBoard = function(length, speed) {
    var score;
    this.length = length;
    this.speed = speed != null ? speed : 50 / 300;
...
Game = (function() {
  ...
  Game.prototype.buildRow = function() {
    ...
    this.rowsGenerated++;
    if (this.rowsGenerated >= this.options.initialRows) {
      return this.buildNextRowAt = getTimestamp() + this.options.newRowInterval;
    } else {
      return this.buildNextRowAt = getTimestamp() + 200;
    }
  };
