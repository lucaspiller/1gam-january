...
Game = (function() {
  ...
  Game.prototype.pullBall = function(x) {
    ...
    if (ball) {
      ...
      if (!lastPulledBall || lastPulledBall.colour === ball.colour) {
        ...
        return this.characterBalls.push(ball);
      }
    }
  };
  ...
  Game.prototype.findAndDestroyBalls = function(x) {
    var ball, columnBalls, deleteToIndex, pushedColour, pushedColumnIndex, rowIndex, searched, toDelete, toSearch, tupleExists, y, _i, _j, _k, _len, _ref, _ref1, _ref2, _ref3, _results;
    ...
    if ((columnBalls.length - 1) - rowIndex >= 3) {
      ...
      for (_k = 0, _len = toDelete.length; _k < _len; _k++) {
        ...
        _results.push(this.options.renderComponent.destroyBallFromColumn(ball, x + 1));
      }
      return _results;
    }
  };
